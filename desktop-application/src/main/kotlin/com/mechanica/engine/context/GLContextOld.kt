...
object GLContextOld : Version {
    ...
    override val version: String
        get() = parsedVersionString?.version?.toString() ?: throw IllegalStateException(errorMessage)
    ...
    fun initialize(window: DesktopWindow) {
...
//        }
    ...
    fun setCallbacks(window: DesktopWindow, callbacks: EventCallbacks) {
